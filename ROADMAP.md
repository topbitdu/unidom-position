...
2. Improve the Post model to add the ``has_many :inferior_post_reporting_structures``, #superior_post_reporting_structures, #inferior_posts, & #superior_posts associations
